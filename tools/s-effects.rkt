...
(define effects
  '((host.io.println bootstrap implemented effect "bridge to std.io.println")
    ...
    (host.file.write bootstrap implemented effect "bridge to std.file.write_text")
    (host.json.encode bootstrap implemented pure "bridge to std.json.encode")
    (host.str.lines_count bootstrap implemented pure "bridge to std.str.lines_count")
    (host.str.lines bootstrap implemented pure "bridge to std.str.lines")
    ...
    (host.str.split bootstrap implemented pure "bridge to std.str.split")
    (host.math.parse bootstrap implemented pure "bridge to std.num.parse")
    ...
    (std.file.read_text std stable-v0.1 effect "S std module text file read")
    (std.file.write_text std stable-v0.1 effect "S std module text file write")
    (std.json.encode std stable-v0.1 pure "S std module JSON encode")
    (std.str.lines_count std stable-v0.1 pure "S std module string count")
    (std.str.lines std stable-v0.1 pure "S std module string lines")
    (std.str.len std stable-v0.1 pure "S std module string length")
    (std.str.join std stable-v0.1 pure "user-facing string join")
    (std.str.add std stable-v0.1 pure "S std module string concat")
    (std.str.eq std stable-v0.1 pure "S std module string equality")
    (std.str.contains std stable-v0.1 pure "S std module string contains")
    (std.str.trim std stable-v0.1 pure "S std module string trim")
    (std.str.upper std stable-v0.1 pure "S std module string uppercase")
    (std.str.lower std stable-v0.1 pure "S std module string lowercase")
    (std.str.split std stable-v0.1 pure "S std module string split")
    (std.num.parse std stable-v0.1 pure "S std module numeric parse")
    (std.num.abs std stable-v0.1 pure "S std module numeric abs")
    (std.num.min std stable-v0.1 pure "user-facing numeric min")
    (std.num.max std stable-v0.1 pure "user-facing numeric max")
    (std.num.round std stable-v0.1 pure "S std module numeric round")
