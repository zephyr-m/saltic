...
(define effects
  '((host.io.println bootstrap implemented effect "bridge to std.io.println")
    ...
    (std.str.lines std stable-v0.1 pure "user-facing string lines")
    ...
    (std.str.split std stable-v0.1 pure "user-facing string split")
    (std.num.parse std stable-v0.1 pure "user-facing numeric parse")
