...
> **УСТАРЕЛ — 2026-09. Аннулирован.**
> Этот аудит опирался на две позиции, которые сейчас отменены владельцем
> (см. `PHILOSOPHY.md`): (1) память как «неперемещающий mark-and-sweep» —
> аннулировано, канон теперь «квота»; (2) «две несовместимые истории ABI» —
> решено, `rescue` — канон, `error.X` подлежит решению в пункте 6.
> Кроме того, разделы о «квадратичности Buffer», «пересоздании таблицы команд»,
> «записи плоской группой» и «goldens только на 1 addi» — закрыты более поздними
> коммитами `6069d64` и `3a188b1`. Актуальное состояние — в новом аудите.
