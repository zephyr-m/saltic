...
Состояние плана после проверки 24 августа 2026 года:
...
- пункт 4 — `ГОТОВО` как таблица, VM ещё не исполняет её как единый профиль;
- пункт 5 — `ГОТОВО`, доказан воротами `stage-3-machine`;
- пункты 6–7 — `НЕ ЗАКРЫТЫ`;
...
│
├─ 4. Точный профиль процессора — 100–180 — ГОТОВО КАК ТАБЛИЦА
