...
- `canonical.saltic` — полная корректная программа;
- `tests/canonical-errors.saltic` — синтаксически корректная программа со всеми
...
- `checker.saltic` — parser и checker с общей точкой входа;
